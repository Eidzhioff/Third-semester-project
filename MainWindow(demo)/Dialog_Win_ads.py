...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        with sq.connect("newdb.db") as con:
            ...
            cur.execute(f"SELECT {self.dictt} FROM apart WHERE ROWID == 57")
            for i in cur:
                for x in i:
                    self.a+= "|" + str(x)
        ...
        self.len_foder_img = len(os.listdir(path="1"))
        ...
        self.pushButton_3.setIcon(QIcon(f"1\\{self.num_img}.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Сюда вписать объявление"))
